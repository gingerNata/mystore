 ...
 *   id = "taxonomy_tid_from_entity",
 *   title = @Translation("Taxonomy term ID from any entity")
 * )
 */
class CurrentTerm extends ArgumentDefaultPluginBase implements CacheableDependencyInterface {
  ...
  public function buildOptionsForm(&$form, FormStateInterface $form_state) {
    ...
    $form['limit'] = [
      ...
      '#states' => [
        'visible' => [
          ':input[name="options[argument_default][taxonomy_tid_from_entity][entity]"]' => ['checked' => TRUE],
        ],
      ],
    ];
    ...
    $form['vids'] = [
      ...
      '#states' => [
        'visible' => [
          ':input[name="options[argument_default][taxonomy_tid_from_entity][limit]"]' => ['checked' => TRUE],
          ':input[name="options[argument_default][taxonomy_tid_from_entity][entity]"]' => ['checked' => TRUE],
        ],
      ],
    ];
